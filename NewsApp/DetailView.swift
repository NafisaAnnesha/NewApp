...
//            RadialGradient(gradient: Gradient(colors: [ Color("Color-1"),  Color("Color-3")]), center: .center, startRadius: 2, endRadius: 650)                .edgesIgnoringSafeArea([.all])
     ...
     Text(title)
        ...
        //    Link("Show in browser", destination: URL(string: urlString)!)
